...
const LabMap = ({ userCoords, labCoords, labName }) => {
  ...
  useEffect(() => {
    ...
    const userMarker = L.marker([userCoords.lat, userCoords.lng], {
      icon: L.divIcon({
        ...
        html: '<div style="background: #3b82f6; width: 14px; height: 14px; border-radius: 50%; border: 2px solid white; box-shadow: 0 0 15px rgba(59, 130, 246, 0.6);"></div>',
        iconSize: [14, 14]
      })
